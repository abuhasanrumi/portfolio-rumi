    ...
    return (
        <div>
            ...
            <div className="blogs py-5">
                <div className="row ">
                    <div className="card my-4 single-blog col-md-6 col-lg-4">
                        <a target="_blank" rel="noopener noreferrer" className="text-white" href="https://medium.com/zenofai/beginners-guide-to-reactjs-3ca07f56d526">
                            <img className="card-img-top" src={blog1} alt="Beginners Guide to ReactJS" />
                    ...
                    <div className="card my-4 single-blog col-md-6 col-lg-4">
                        <a target="_blank" rel="noopener noreferrer" className="text-white" href="https://medium.com/@LindaVivah/the-beginners-guide-understanding-node-js-express-js-fundamentals-e15493462be1">
                            <img className="card-img-top" src={blog2} alt="Understanding Node.js" />
                            <div className="card-body blog-text">
                    ...
                    <div className="card my-4 single-blog col-md-6 col-lg-4">
                        <a target="_blank" rel="noopener noreferrer" className="text-white" href="https://medium.com/javascript-training/beginner-s-guide-to-webpack-b1f1a3638460">
                            <img className="card-img-top" src={blog3} alt="What is REST" />
                            <div className="card-body blog-text">
            ...
            <div className="blog-btn text-center">
                <a className="btn hero-btn touch-btn py-2 px-3 py-md-3 px-md-5 mono-text" href="/blog">See More</a>
            </div>
        </div>
    );
};
